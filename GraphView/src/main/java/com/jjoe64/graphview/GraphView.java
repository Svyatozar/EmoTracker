...
abstract public class GraphView extends LinearLayout {
    ...
    private OnTouchEventInterceptor onTouchEventInterceptor;
	...
	private class GraphViewContentView extends View
    {
        ...
        {
            onTouchEventInterceptor.onTouchEvent(GraphView.this, event);
        ...
        public void invokeTouchEvent(MotionEvent event)
        {
    ...
    public void invokeTouchEvent(MotionEvent event)
    {
        graphViewContentView.invokeTouchEvent(event);
    }
     ...
     * @param title [optional]
     */
    public GraphView(Context context, String title, OnTouchEventInterceptor onTouchEventInterceptor)
    {
        super(context);
        setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
